...
CREATE TABLE `Episodio_Salud` (
    ...
    `fecha` DATE,
    CONSTRAINT `histc` FOREIGN KEY (`nro_hist`)
        REFERENCES `Historia_Clinica` (`nro_hist`)
...
CREATE TABLE `Ocurre`(
    ...
    CONSTRAINT `FK_Agreg` FOREIGN KEY (`nro_casa`,`nro_doc_personal`, `tipo_doc_personal`) REFERENCES `a_cargo`(`nro_casa`,`nro_doc_personal`,`tipo_doc_personal`) ON DELETE CASCADE ON UPDATE CASCADE
  )ENGINE InnoDB;
