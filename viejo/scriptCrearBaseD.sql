...
CREATE TABLE `Visita` (
    ...
    CONSTRAINT `doc_visitante` FOREIGN KEY (`nro_doc_visitante`,`tipo_doc_visitante`) REFERENCES `Visitante`(`nro_doc`,`tipo_doc_visitante`) ON DELETE CASCADE ON UPDATE CASCADE
)ENGINE InnoDB;
